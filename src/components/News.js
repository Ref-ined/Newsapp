...
const News =(props)=>{
    ...
    useEffect(() => {
        document.title = `${capitalizeFirstLetter(props.category)} - Samachar Baba`;
        updateNews();
    ...
    const fetchMoreData = async () => {
        ...
        return (
            <>
                <h1 className="text-center" style={{ margin: '40px 0px' ,marginTop:'90px' }}>Samachar Baba - Top {capitalizeFirstLetter(props.category)} Headlines</h1>
                {loading && <Spinner /> }
